...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.85\textwidth]{lecture01_text_classification_pipeline.png}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.65\textwidth]{lecture01_embedding_analogy.png}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.9\textwidth]{lecture01_skipgram_training_samples.png}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.9\textwidth]{lecture01_word2vec_network.png}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.8\textwidth]{lecture01_embedding_lookup_table.png}
...
\begin{figure}[H]
     \centering
     \includegraphics[width=0.9\textwidth]{lecture01_cbow_vs_skipgram.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{lecture02_word2vec_training_samples.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture02_word2vec_network.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture02_crosslingual_embeddings_similarity.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{lecture02_unsupervised_mapping_gan.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture02_bigram_convolution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{lecture02_kim2014_cnn.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture02_attention_alignment.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{lecture03_smt_bayes.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture03_word_alignment_many_to_many.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture03_pbmt_search.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{lecture03_seq2seq_decoding.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{lecture03_beam_search_example.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{lecture03_seq2seq_bottleneck.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture03_attention_weighted_sum.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture04_attention_advantages.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture04_transformer_stack.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{lecture04_encoder_block.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{lecture04_self_attention_high_level.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{lecture04_scaled_dot_product_attention.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture04_positional_encoding_sincos.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture04_decoder_mask.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{lecture05_self_attention_matrix.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{lecture05_multi_head_attention.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture05_positional_encoding.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{lecture05_transformer_recap.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture05_openai_transformer_finetuning.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{lecture05_input_transformations.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture05_elmo_bilm.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture05_bert_classification.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{lecture06_ssl_evaluation_pipeline.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{lecture06_rotation_prediction.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{lecture06_jigsaw_pretext.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture06_inpainting_encoder_decoder.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{lecture06_simclr_positive_pairs.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{lecture06_moco_scheme.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{lecture06_cpc_overview.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture07_agent_environment_loop.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture07_mdp_formalism.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture07_cem_tabular_overview.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture07_cem_policy_update.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{lecture07_approximate_cem.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture08_mdp_definition.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture08_discounting_finite_sum.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture08_discounting_end_of_effect.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture08_reward_shaping.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{lecture08_backup_tree.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture08_state_value_function.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture08_bellman_expectation_equations.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture08_bellman_optimality_q.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture09_discounting_finite_sum.png}
    \caption{Discounting делает бесконечную сумму reward конечной.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{lecture09_learning_from_trajectories.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture09_monte_carlo_paths.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture09_q_learning_update.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture09_mc_vs_td.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture10_q_approximation_error.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture10_value_based_vs_policy_based.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture10_reinforce_q_using_g.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{lecture10_discounted_returns_linear_time.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{lecture10_actor_critic.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture10_a3c_scheme.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture11_encoder_decoder_tasks.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture11_attentive_translation_alignment.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture11_distribution_shift.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture11_seq2seq_as_pomdp.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture11_training_vs_inference.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture11_scst_advantage.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{lecture11_scst_results.png}
